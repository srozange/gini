...
public class GiniContextTest {
	...
	public void shoud_succeed() {
		...
		assertThat(root.getStep1().method1()).isEqualTo(
				"interceptor => stepImpl1");
		assertThat(root.getStep2()).isInstanceOf(StepImpl2.class);
		assertThat(root.getStep2().method1()).isEqualTo(
				"interceptor => stepImpl2");
		assertThat(root.getConcreteStep()).isInstanceOf(StepImpl1.class);
		assertThat(root.getConcreteStep().getRule()).isInstanceOf(
				RuleImpl.class);
	}
